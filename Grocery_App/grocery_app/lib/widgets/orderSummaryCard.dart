      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            widget.document.data()['sold'] == false
                ? _orderController.statusSoldContainer(widget.document, context)
                : Container(),

            widget.document.data()['orderStatus'] == 'Accepted'
                ? _orderController.statusAcceptedContainer(
                    widget.document, context)
                : Container(),

            widget.document.data()['orderStatus'] == 'Rejected'
                ? _orderController.statusDeleteContainer(
                    widget.document, context)
                : Container(),
